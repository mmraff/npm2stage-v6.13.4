...
function checkVersionInPackageJson(npmDir) {
  ...
  .catch(err => {
    /*
      Re Testing: Because it's too impractical to force a filesystem error,
      and because of impracticality of changing file access on Windows...
    */
...
module.exports.removeAddedItems = function() {
  ...
  // TODO: decide if we should concat the CHANGED_FILES, just to be safe?
